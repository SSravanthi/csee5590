...
// Initialize the variable colors
// assign an array of colors to a variable colors

let colors;
colors = ["22ac5e", "d68236", "71b5c2", "af2655", "b34de7", "e6bd01", "104393", "ca4d94", "4a772d", "c180a7", "958112", "8d2f8d"];
...
// the content of the input gets cleared and the focus gets back on the input
    $('#add-to-favorite').click(function(){
        color = $("#color").val(); // Clears the value
        addBox(color); //
        $("#color").val('').focus(); // cursor focus on input
    });
